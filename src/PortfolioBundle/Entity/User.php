 ...
 * @UniqueEntity("email", message="The e-mail address you used is already registered")
 * @UniqueEntity("username", message="Someone else has already chosen that username")
 */
