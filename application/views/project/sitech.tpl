...
$(document).ready(function () {
	$('#sitech-accord').accordion({active: false, clearStyle: true, collapsible: true, icons: {'header': 'ui-icon-plus', 'headerSelected': 'ui-icon-minus'}});
	$('#sitech-accord a').click(function (event) {
		var href = $(this).attr('href');
		if (href.charAt(0) == '#') {
			event.preventDefault();
			$('#sitech-accord').accordion('option', 'active', $('a[name="' + href.substr(1) + '"]').parent())
		}
	});
});
</script>
		...
		<div id="box" class="ui-widget ui-widget-content ui-corner-all">
			...
			<p>
				...
				<ul id="sitech-accord">
					<li>
						<h4><a name="SiTechConfigParser">SiTech\ConfigParser</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechConsole">SiTech\Console</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechController">SiTech\Controller</a></h4>
						<div>
							While SiTech is not a framework, I have included very basic controller code to aid in
							development. This can be used in combination with <a href="#SiTechTemplate">SiTech\Template</a>
							to create a simple framework.
						</div>
					</li>
					<li>
						<h4><a name="SiTechDB">SiTech\DB</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechFilter">SiTech\Filter</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechLoader">SiTech\Loader</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechSession">SiTech\Session</a></h4>
						<div>
							...
							the traditional flat files, or a database engine that uses the <a href="#SiTechDB">SiTech\DB</a>
					...
					<li>
						<h4><a name="SiTechTemplate">SiTech\Template</a></h4>
						<div>
					...
					<li>
						<h4><a name="SiTechUri">SiTech\Uri</a></h4>
						<div>
