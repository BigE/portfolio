	...
	$('#examples').accordion();
			...
			<div id="description" class="ui-widget ui-widget-content ui-corner-all">
				...
				<p>
					...
					<a href="http://jigsaw.w3.org/css-validator/validator?uri=<?php echo urlencode(SITECH_BASEURI.'/css/general.css'); ?>&amp;profile=css3"><img style="border:0;width:88px;height:31px" src="http://jigsaw.w3.org/css-validator/images/vcss" alt="Valid CSS!" /></a>
				</p>
				<div id="ie6"></div>
			</div>
			<div id="box" class="ui-widget ui-widget-content ui-corner-all" style="padding-bottom: 120px;">
				...
				<div id="examples">
					<h3><a href="#">PHP Technologies</a></h3>
					<div>
						<ul class="projects">
							<li><a href="diff">PHP Diff</a></li>
							<li><a href="gallery">Gallery</a></li>
							<li><a href="sitech">SiTech Library</a></li>
						</ul>
					</div>
					<h3><a href="#">Python</a></h3>
					<div>
						<ul class="projects">
							<li><a href="simpleirc">SimpleIRC</a></li>
						</ul>
					</div>
					<h3><a href="">C/C++/C#</a></h3>
					<div>
						<ul class="projects">
							<li><a href="irssinotify">IrssiNotify (C#)</a></li>
							<li><a href="liboscar">liboscar (C)</a></li>
						</ul>
					</div>
				</div>
			</div>